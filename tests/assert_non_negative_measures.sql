select
    'fct_deaths_weekly' as model_name,
    week_key::text as grain_key,
    deaths_count::numeric as invalid_value
...
select
    ...
    concat(week_key, ':', county_key),
    accident_count::numeric
...
from {{ ref('fct_weather_weekly_county') }}
where total_sunshine_duration < 0
